...
public class MbsAllSearchTest {
    ...
    public void setUp() throws Exception {
        ...
        //멤버십 디테일 생성 (멤버십상태 : 활성화) - MEMBERSHIP_ID3
        MembershipDetailEntity membershipDetailEntity3 = MembershipDetailEntity.
                create(membershipRepository.findById(MEMBERSHIP_ID3).get(),
                        membershipUserRepository.findById(USER_ID).get(),
                        POINT, "Y");
    ...
    @Test
    @DisplayName("멤버십전체조회 - 정상")
    void 멤버십전체조회_정상() throws Exception {
        // given
    ...
    @Test
    @DisplayName("멤버십전체조회 - 조회대상인 유저가 없는 경우 - 에러")
    void 멤버십전체조회_조회대상인유저가없는_Exception() throws Exception {
        // given
